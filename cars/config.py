...
class SITE_URLS:
    class KCar:
        catalog_url = "https://api.kcar.com/bc/timeDealCar/list"
        car_url = 'https://api.kcar.com/bc/car-info-detail-of-ng?i_sCarCd=EC61115610&i_sPassYn=N&bltbdKnd=CM050'
        cookies = {
    ...
    class Mpark:
        catalog_url = "https://api.m-park.co.kr/home/api/v1/wb/searchmycar/carlistinfo/get?"

    class Charancha:
        catalog_url = "https://charancha.com/v1/cars"
